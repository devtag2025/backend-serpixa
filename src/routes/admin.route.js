...
router.post('/users/:userId/assign-admin', validate.userIdParam, adminController.assignAdminRole);
...
// CONTACT REQUESTS
// ============================================
router.get('/contact-requests', validate.paginationQuery, adminController.getContactRequests);
