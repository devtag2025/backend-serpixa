...
export const runAudit = async (req, res, next) => {
  try {
    ...
    const audit = await GeoAudit.create({
      ...
      scoreSummary: auditResult.scoreSummary ?? null,
      strengths: auditResult.strengths ?? null,
      userPositionInPack: auditResult.userPositionInPack ?? null,
      businessNotInLocation: auditResult.businessNotInLocation ?? false,
